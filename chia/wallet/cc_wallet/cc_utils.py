...
def get_lineage_proof_from_coin_and_puz(coin: Coin, puz: Program) -> Optional[LineageProof]:
...
def get_cat_truths(spendable_cc: SpendableCC, limitations_program: Program, limitations_solution: Program) -> Program:
    ...
    lineage_proof = spendable_cc.lineage_proof.to_program() if spendable_cc.lineage_proof else []
...
def spend_bundle_for_spendable_ccs(
    ...
    for index in range(N):
        ...
        solution = [
            ...
            cc_spend_info.lineage_proof.to_program() if cc_spend_info.lineage_proof else [],
            prev_id,
            my_info,
            next_info,
            subtotals[index],
